      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="mb-6">
              <Image
                src="/images/AFAQ-light-logo.png"
                alt="آفاق المتكاملة لتكنولوجيا المعلومات"
                width={150}
                height={60}
                className="h-auto w-40 mb-2"
              />
            </div>
            ...
            <div className="flex gap-3">
              ...
              <Link
                ...
                target="_blank"
                className="social-icon w-10 h-10 bg-purple-600 rounded-full flex items-center justify-center hover:bg-pink-600 transition-all duration-300 hover:-translate-y-1"
              >
